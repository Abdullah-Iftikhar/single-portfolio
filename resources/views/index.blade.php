...
{{--                        </a>--}}
{{--                        <div class="text">--}}
{{--                            <p class="meta"><span><i class="fa fa-calendar me-1"></i>Jan. 18, 2021</span> <span><a--}}
{{--                                        href="#"><i--}}
...
{{--                         data-aos-delay="100">--}}
{{--                        <a href="blog-single.html" class="block-20 img"--}}
{{--                           style="background-image:url({{asset('assets/images/ximage_2.jpg.pagespeed.ic.cSUVyMwItV.jpg')}})">--}}
{{--                        </a>--}}
{{--                        <div class="text">--}}
{{--                            <p class="meta"><span><i class="fa fa-calendar me-1"></i>Jan. 18, 2021</span> <span><a--}}
{{--                                        href="#"><i--}}
...
{{--                         data-aos-delay="100">--}}
{{--                        <a href="blog-single.html" class="block-20 img"--}}
{{--                           style="background-image:url({{asset('assets/images/ximage_3.jpg.pagespeed.ic.5zztMSovUH.jpg')}})">--}}
{{--                        </a>--}}
{{--                        <div class="text">--}}
{{--                            <p class="meta"><span><i class="fa fa-calendar me-1"></i>Jan. 18, 2021</span> <span><a--}}
{{--                                        href="#"><i--}}
...
{{--                         data-aos-delay="100">--}}
{{--                        <a href="blog-single.html" class="block-20 img"--}}
{{--                           style="background-image:url({{asset('assets/images/ximage_4.jpg.pagespeed.ic.0mxmKkOd81.jpg')}})">--}}
{{--                        </a>--}}
{{--                        <div class="text">--}}
{{--                            <p class="meta"><span><i class="fa fa-calendar me-1"></i>Jan. 18, 2021</span> <span><a--}}
{{--                                        href="#"><i--}}
...
{{--                         data-aos-delay="100">--}}
{{--                        <a href="blog-single.html" class="block-20 img"--}}
{{--                           style="background-image:url({{asset('assets/images/ximage_5.jpg.pagespeed.ic.uC7KZcyuOx.jpg')}})">--}}
{{--                        </a>--}}
{{--                        <div class="text">--}}
{{--                            <p class="meta"><span><i class="fa fa-calendar me-1"></i>Jan. 18, 2021</span> <span><a--}}
{{--                                        href="#"><i--}}
